...
PL_SUBDIR = 'zcu111_960x540'
PL_DIR = os.path.join(WORK_DIR, PL_SUBDIR)
BIT_PATH = os.path.join(PL_DIR, 'dpu.bit')

PRE_DIR = os.path.join(WORK_DIR, 'imgs_preprocessed_960x540')
CODEBOOK_PATH = os.path.join(WORK_DIR, 'codebook/codebook_som.npy')
VQ_CODEBOOK_PATH = os.path.join(WORK_DIR, 'codebook/codebook_som_vq_960x540.npy')
ENC_XMODEL = os.path.join(WORK_DIR, 'xmodel/encoder_960x540_som.xmodel')
DEC_XMODEL = os.path.join(WORK_DIR, 'xmodel/decoder_960x540_som.xmodel')
# CODEBOOK_PATH = os.path.join(WORK_DIR, 'codebook.npy')
# ENC_XMODEL = os.path.join(WORK_DIR, 'xmodel/encoder_960x540.xmodel')
# DEC_XMODEL = os.path.join(WORK_DIR, 'xmodel/decoder_960x540.xmodel')

RES_DIR = os.path.join(PL_DIR, 'results_960x540')
