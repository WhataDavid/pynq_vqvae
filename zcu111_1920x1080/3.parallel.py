...
print("=" * 80, flush=True)
print("3.parallel_no_zq_save.py: idx -> vq_dequant -> Decoder -> recon", flush=True)
print("Async pipeline, no zq_npy save/load", flush=True)
print("=" * 80, flush=True)
...
print("NUM_ZQ_BUFS     :", NUM_ZQ_BUFS, flush=True)
print("=" * 80, flush=True)
