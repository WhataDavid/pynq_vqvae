...
VQ_CODEBOOK_PATH = os.path.join(WORK_DIR, 'codebook/codebook_som_vq_1920x1080.npy')
ENC_XMODEL = os.path.join(WORK_DIR, 'xmodel/encoder_1920x1080_cv2.xmodel')
DEC_XMODEL = os.path.join(WORK_DIR, 'xmodel/decoder_1920x1080_realzq.xmodel')
