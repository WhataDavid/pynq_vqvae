...
# 1920x1080 的 enc_out_np 约 8.29 MB/张，不建议太大。
READ_Q_DEPTH = 2
ENC_TO_VQ_Q_DEPTH = 2
...
print("=" * 80, flush=True)
print("2.parallel_optimized.py: Read worker -> Main-thread Encoder -> VQ/Save worker", flush=True)
print("=" * 80, flush=True)
...
print("REPEAT_DATASET  :", REPEAT_DATASET, flush=True)
print("=" * 80, flush=True)
